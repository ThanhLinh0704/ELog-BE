...
import com.elog.dto.request.vehicle.*;
import com.elog.dto.response.common.ApiResponse;
import com.elog.dto.response.vehicle.*;
...
class VehicleServiceImplTest {
    ...
    void createVehicleSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);UserRepository users=mock(UserRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);VehicleCreateRequest req=new VehicleCreateRequest();req.setPlateNumber("29A-12345");req.setPayloadKg(new BigDecimal("1000"));req.setMaxVolumeM3(new BigDecimal("10"));when(mapper.normalizePlate("29A-12345")).thenReturn("29A-12345");when(vehicles.existsByPlateNumber("29A-12345")).thenReturn(false);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").build();when(mapper.toEntity(req)).thenReturn(v);when(vehicles.save(v)).thenReturn(v);when(mapper.toResponse(v)).thenReturn(VehicleResponse.builder().id(10L).plateNumber("29A-12345").build());VehicleResponse resp=new VehicleServiceImpl(vehicles,users,mapper).createVehicle(req);assertEquals(10L,resp.getId());}
    @Test @DisplayName("[L1-VH-14] getVehicleById returns vehicle details")
    void getVehicleByIdSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").build();when(vehicles.findById(10L)).thenReturn(java.util.Optional.of(v));when(mapper.toResponse(v)).thenReturn(VehicleResponse.builder().id(10L).plateNumber("29A-12345").build());VehicleResponse resp=new VehicleServiceImpl(vehicles,mock(UserRepository.class),mapper).getVehicleById(10L);assertEquals(10L,resp.getId());}
    @Test @DisplayName("[L1-VH-15] getAllVehicles returns paginated list")
    void getAllVehiclesSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").build();org.springframework.data.domain.Pageable pageable=org.springframework.data.domain.PageRequest.of(0,10);when(vehicles.findAll(org.mockito.ArgumentMatchers.<org.springframework.data.jpa.domain.Specification<com.elog.entity.Vehicle>>any(),eq(pageable))).thenReturn(new org.springframework.data.domain.PageImpl<>(java.util.List.of(v)));when(mapper.toListItem(v)).thenReturn(VehicleListItemResponse.builder().id(10L).plateNumber("29A-12345").build());ApiResponse<java.util.List<VehicleListItemResponse>> resp=new VehicleServiceImpl(vehicles,mock(UserRepository.class),mapper).getAllVehicles(null,null,null,null,pageable);assertTrue(resp.isSuccess());assertEquals(1,resp.getData().size());}
    @Test @DisplayName("[L1-VH-16] updateVehicle updates vehicle fields")
    void updateVehicleSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").build();VehicleUpdateRequest req=new VehicleUpdateRequest();req.setPayloadKg(new BigDecimal("1000"));req.setMaxVolumeM3(new BigDecimal("10"));when(vehicles.findById(10L)).thenReturn(java.util.Optional.of(v));when(vehicles.save(v)).thenReturn(v);when(mapper.toResponse(v)).thenReturn(VehicleResponse.builder().id(10L).plateNumber("29A-12345").build());VehicleResponse resp=new VehicleServiceImpl(vehicles,mock(UserRepository.class),mapper).updateVehicle(10L,req);assertEquals(10L,resp.getId());}
    @Test @DisplayName("[L1-VH-17] updateVehicleStatus updates active flag")
    void updateVehicleStatusSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").isActive(true).build();VehicleStatusUpdateRequest req=new VehicleStatusUpdateRequest();req.setIsActive(false);when(vehicles.findById(10L)).thenReturn(java.util.Optional.of(v));when(vehicles.save(v)).thenReturn(v);when(mapper.toResponse(v)).thenReturn(VehicleResponse.builder().id(10L).isActive(false).build());VehicleResponse resp=new VehicleServiceImpl(vehicles,mock(UserRepository.class),mapper).updateVehicleStatus(10L,req);assertFalse(resp.getIsActive());}
    @Test @DisplayName("[L1-VH-18] findAvailableVehiclesForTrip returns active available vehicles")
    void findAvailableVehiclesForTripSuccess(){VehicleRepository vehicles=mock(VehicleRepository.class);VehicleMapper mapper=mock(VehicleMapper.class);com.elog.entity.Vehicle v=com.elog.entity.Vehicle.builder().id(10L).plateNumber("29A-12345").isActive(true).status(com.elog.entity.VehicleStatus.AVAILABLE).build();when(vehicles.findAll()).thenReturn(java.util.List.of(v));when(mapper.toResponse(v)).thenReturn(VehicleResponse.builder().id(10L).build());java.util.List<VehicleResponse> list=new VehicleServiceImpl(vehicles,mock(UserRepository.class),mapper).findAvailableVehiclesForTrip(100L);assertEquals(1,list.size());}
}
