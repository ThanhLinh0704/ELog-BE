...
public enum ErrorCode {
    ...
    NOT_YOUR_TRIP("NOT_YOUR_TRIP"), // Driver gọi action trên trip không phải của mình
    TRIP_STOP_NOT_FOUND("TRIP_STOP_NOT_FOUND"), // Trip stop ID không tồn tại
    STOP_NOT_PENDING("STOP_NOT_PENDING"), // Arrive khi stop không phải PENDING
    STOP_NOT_IN_PROGRESS("STOP_NOT_IN_PROGRESS"), // Complete/Reject khi stop không phải IN_PROGRESS
    STOP_ALREADY_DONE("STOP_ALREADY_DONE"), // Stop đã COMPLETED hoặc EXCEPTION
    PREVIOUS_STOP_NOT_DONE("PREVIOUS_STOP_NOT_DONE"), // Driver skip stop — phải đến tuần tự
